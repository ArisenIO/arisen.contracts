...
namespace arisensystem {
    ...
    */
   struct [[arisen::table, arisen::contract("arisen.system")]] exchange_state {
      asset    supply;
   ...
   typedef arisen::multi_index< "rammarket"_n, exchange_state > rammarket;
   /** @}*/ // enf of @addtogroup arisensystem
} /// namespace arisensystem
